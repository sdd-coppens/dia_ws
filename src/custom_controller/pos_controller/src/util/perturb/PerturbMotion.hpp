...
void perturb_motion(const Eigen::Vector3f &p, const Eigen::Vector3f &closest_point,
                    const Eigen::Vector3f &closest_point_remote, Eigen::Vector3f &perturbed_point, std::ofstream *perturb_log_file_) {
...
void get_new_point(const Eigen::Vector3f &p, const float point_radius,
                   ...
                   Eigen::Vector3f &perturbed_point, std::ofstream *perturb_log_file_) {
    ...
    perturb_motion(closest_point_on_pointer, closest_point, closest_point_remote, perturbed_point, perturb_log_file_);
}
